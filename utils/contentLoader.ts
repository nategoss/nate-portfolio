...
// This would normally be implemented with a markdown parser like 'gray-matter'
// For this demo, we'll simulate loading from markdown files
...
// Simulated markdown content - in a real implementation, this would read actual files
const caseStudyContent = new Map<string, Project>([
  ['ecommerce-platform', {
...
const caseStudyIndex: CaseStudyIndex = {
  featured: ["ecommerce-platform", "healthtech-app", "fintech-brand"],
  published: ["ecommerce-platform", "healthtech-app", "fintech-brand"],
...
export const loadCaseStudyIndex = async (): Promise<CaseStudyIndex> => {
  // In a real implementation, this would fetch from /content/case-studies.json
...
export const loadCaseStudy = async (slug: string): Promise<Project | null> => {
  ...
  // 3. Parse markdown content for detailed content
  // 4. Combine into Project object
  
  return caseStudyContent.get(slug) || null
}
